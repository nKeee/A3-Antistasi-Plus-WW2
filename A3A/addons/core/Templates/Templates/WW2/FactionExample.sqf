...
_militaryLoadoutData set ["vests", ["V_LIB_GER_VestKar98_8a"]];
_militaryLoadoutData set ["backpacks", ["B_LIB_GER_A_frame_Vide"]];
_militaryLoadoutData set ["helmets", ["H_LIB_GER_Helmet_os"]];
